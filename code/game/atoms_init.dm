...
/atom/New(loc, ...)
	...
	// This preloader code is also duplicated in /turf/unsimulated/New() and /obj/effect/floor_decal/Initialize(). If you change this, be sure to change it there, too.
